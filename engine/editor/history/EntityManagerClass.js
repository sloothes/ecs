...
//	https://stackoverflow.com/questions/11337849/ways-to-extend-array-object-in-javascript
	...
	function EntityManager( droplist ){
		var array = new Array(0);
		Object.setPrototypeOf( array, EntityManager.prototype );
		if ( droplist ) array.entity_droplist = droplist;
		return array; // important!
	};

	EntityManager.prototype = Object.create(Array.prototype);
//	EntityManager.prototype.entity_droplist = document.getElementById("entities-droplist"); // manual.
	...
	//	var entity_droplist = document.getElementById("entities-droplist");
		...
		if ( !this.entity_droplist ) return; 
		var entity_droplist = this.entity_droplist;
